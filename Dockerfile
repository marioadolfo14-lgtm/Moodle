...
# Clone the Moodle repository directly (Corregido)
RUN git clone -b MOODLE_405_STABLE --single-branch git://git.moodle.org/moodle.git /tmp/moodle && \
...
# Set working directory (Corregido)
WORKDIR /var/www/html

# Set correct permissions (Corregido)
